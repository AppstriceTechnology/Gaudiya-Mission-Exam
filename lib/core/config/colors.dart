...
const klPrimaryColor = Color(0xFFF76245);
...
const kdPrimaryColor = Color(0xFFF76245);
...
const Color kHurryUpTimerColor = Color(0xFFF76245);
const Color kCorrectAnswerColor = Color(0xFF5DB760);
const Color kWrongAnswerColor = Color(0xFFF76245);
